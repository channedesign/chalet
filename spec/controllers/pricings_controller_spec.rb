...
RSpec.describe PricingsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested pricing as @pricing" do
      pricing = Pricing.create! valid_attributes
      get :show,  {id: pricing.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested pricing as @pricing" do
      pricing = Pricing.create! valid_attributes
      get :edit,  {id: pricing.to_param}, session: valid_session
      expect(assigns(:pricing)).to eq(pricing)
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved pricing as @pricing" do
        post :create,  {pricing: invalid_attributes}, session: valid_session
        expect(assigns(:pricing)).to be_a_new(Pricing)
      end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "assigns the pricing as @pricing" do
        pricing = Pricing.create! valid_attributes
        put :update,  {id: pricing.to_param, pricing: invalid_attributes}, session: valid_session
        expect(assigns(:pricing)).to eq(pricing)
      end
