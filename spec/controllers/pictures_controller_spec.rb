...
RSpec.describe PicturesController, type: :controller do
  ...
  let(:valid_attributes) { attributes_for :picture, house_id: chalet.id }

  let(:invalid_attributes) { attributes_for :picture, house_id: nil }
  ...
  describe "GET #show" do
    it "assigns the requested picture as @picture" do
      picture = Picture.create! valid_attributes
      get :show, id: picture.to_param, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested picture as @picture" do
      picture = Picture.create! valid_attributes
      get :edit, id: picture.to_param, session: valid_session
      expect(assigns(:picture)).to eq(picture)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Picture" do
        expect {
          post :create, picture: valid_attributes, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved picture as @picture" do
        post :create, picture: invalid_attributes, session: valid_session
        expect(assigns(:picture)).to be_a_new(Picture)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) { attributes_for :picture, name: 'picture_one' }

      it "updates the requested picture" do
        picture = Picture.create! valid_attributes
        put :update, id: picture.to_param, picture: new_attributes, session: valid_session
        picture.reload
        expect(picture.name).to eq('picture_one')
      end

      it "assigns the requested picture as @picture" do
        picture = Picture.create! valid_attributes
        put :update, id: picture.to_param, picture: valid_attributes, session: valid_session
        expect(assigns(:picture)).to eq(picture)
      end
    ...
    context "with invalid params" do
      it "assigns the picture as @picture" do
        picture = Picture.create! valid_attributes
        put :update, id: picture.to_param, picture: invalid_attributes, session: valid_session
        expect(assigns(:picture)).to eq(picture)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested picture" do
      picture = Picture.create! valid_attributes
      expect {
        delete :destroy, id: picture.to_param, session: valid_session
      }.to change(Picture, :count).by(-1)
    end
